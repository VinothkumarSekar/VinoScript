...
def idrac_ss (esxi_host,idrac_credentials,jsd_ticket,jira_credentials):
    ...
    if idrac_response.status_code == 200 :
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            comment_body += '{' + 'code:title=Final report from workflow:|borderStyle=solid' + '}' + '\n' + 'Validate hardware errors from iDRAC and proceed with reboot' + '\n' + 'Need to work with DCOPS/Vendor for any hardware issues' + '{' + 'code' + '}'
        
    else:
        comment_body = '{' + 'code:title=Final report from workflow:|borderStyle=solid' + '}'+ '\n' + 'Need to capture iDRAC screenshot and proceed with reboot' + '\n' + 'Need to work with DCOPS/Vendor for any hardware issues' + '{' + 'code' + '}'
...
inputs = {
        'jsd_ticket' : 'xx',
        'esxi_host' : "xx-r04esx38.xxx.com",
        'jira_credentials' : 'xx==',
        'idrac_credentials' : 'xx='
    }
