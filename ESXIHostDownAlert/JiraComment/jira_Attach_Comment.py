...
#inputs 
vCenterName = 'xxx-vc24.oc.xxx.com'
esx_host = 'xxx-r12esx01.oc.xxx.com'
jsd_usr = 'svc.xxxx'
jsd_pwd = 'Sd!xxxxxxx.'
vc_user = 'x'
vc_pwd = 'x'
...
def host_id(api_key):
  ...
  for hosts_dict in hosts_list:
    if hosts_dict["name"] == "xxx-r12esx01.xxx.com":
...
def vms(host_id):
  ...
  with tempfile.TemporaryDirectory() as tmpdirname:
      ...
      #Pushing to JIRA
      jsd_url = f"https://servicedesk-xxx.com/rest/api/2/issue/{issue_key}/attachments"
      jsd_headers = {
